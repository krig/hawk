                ...
                '<div class="form-group">',
                  ...
                  '<div class="col-sm-7">',
                    '<div class="input-group">',
                      '<select class="form-control select" name="{{>#parent.parent.parent.parent.parent.data.prefix}}[{{>#parent.getIndex()}}][action]" data-link="#parent.parent.data.role">',
                        '<option></option>',
                        '{^{for #parent.parent.parent.parent.parent.data.selects}}',
                          '<option value="{{:#data}}">',
                            '{{:#data}}',
                          '</option>',
                        '{{/for}}',
    ...
    $.templates.constraints.link(
      ...
      .on('click', '.unlink', function(e) {
        ...
        $.observable(
          ...
          {
            sequential: true,
            role: $.view(this).parent.parent.parent.data.role,
            resources: [
